...
/* 127 */
/*!*******************************************************!*\
  !*** multi babel-polyfill ./src/arcade-navigation.js ***!
  \*******************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = __webpack_require__(/*! /Users/goiblas/Documents/arcade-navigation/src/arcade-navigation.js */330);
...
var _game = __webpack_require__(/*! ./game */ 331);
...
var _utils = __webpack_require__(/*! ./utils */ 345);
...
var ArcadeNavigation = function () {
  function ArcadeNavigation() {
    var settings = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, ArcadeNavigation);

    this.options = _utils2.default.extend(_config2.default, settings);
    this.game = null;
  }

  _createClass(ArcadeNavigation, [{
    key: 'init',
    value: function init() {
      ...
      _utils2.default.addStyle(this.wrapper, styles);
      document.body.appendChild(this.wrapper);

      this.game = new _game2.default(this.wrapper.offsetWidth, this.wrapper.offsetHeight, this.options);
    }
  }, {
    key: 'paused',
...
var _gameState = __webpack_require__(/*! ./game-state */ 336);
...
var Game = function (_Phaser$Game) {
  ...
  function Game(w, h, options) {
    ...
    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, w, h, _phaser2.default.AUTO, options.divName, null, true));

    var GameStateWithAssets = function (_GameState) {
      _inherits(GameStateWithAssets, _GameState);

      function GameStateWithAssets() {
        _classCallCheck(this, GameStateWithAssets);

        return _possibleConstructorReturn(this, (GameStateWithAssets.__proto__ || Object.getPrototypeOf(GameStateWithAssets)).apply(this, arguments));
      }

      _createClass(GameStateWithAssets, [{
        key: 'preload',
      ...
      return GameStateWithAssets;
    }(_gameState2.default);

    _this.state.add('GameState', GameStateWithAssets, false);
...
var _particlesEmitter = __webpack_require__(/*! ./sprites/particles-emitter */ 337);

var _particlesEmitter2 = _interopRequireDefault(_particlesEmitter);

var _ship = __webpack_require__(/*! ./sprites/ship */ 338);

var _ship2 = _interopRequireDefault(_ship);

var _shadow = __webpack_require__(/*! ./sprites/shadow */ 339);

var _shadow2 = _interopRequireDefault(_shadow);

var _holes = __webpack_require__(/*! ./sprites/holes */ 340);

var _holes2 = _interopRequireDefault(_holes);

var _weaponEmitter = __webpack_require__(/*! ./sprites/weapon-emitter */ 341);

var _weaponEmitter2 = _interopRequireDefault(_weaponEmitter);

var _exploseEmitter = __webpack_require__(/*! ./sprites/explose-emitter */ 342);

var _exploseEmitter2 = _interopRequireDefault(_exploseEmitter);

var _enemies = __webpack_require__(/*! ./sprites/enemies */ 343);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.enemies = new _enemies2.default({
        game: this.game,
        tags: this.enemytags
      });

      this.particles = new _particlesEmitter2.default({
        game: this.game,
        asset: 'particle',
        max: 300
      });

      this.holes = new _holes2.default({
        game: this.game,
        asset: 'hole',
        instances: 100
      });
      ...
      this.shadow = new _shadow2.default({
        game: this.game,
        x: 200,
        y: this.middlePosition + 20,
        asset: 'ship',
      ...
      this.weapon = new _weaponEmitter2.default({
        game: this.game,
        asset: 'singlebullet',
        amount: 30,
        distance: 300,
      ...
      this.explosions = new _exploseEmitter2.default({
        game: this.game,
        asset: 'explode',
        instances: 30
    ...
    value: function checkScrollPosition() {
      ...
      var nPos = this.ship.position.y - this.middlePosition;
      var dif = currentScrollPosition - nPos;
    ...
    value: function update() {
      ...
      this.weapon.forEach(function (w) {
        if (w.alive) {
          var tmp = w.lifespan - _this2.game.time.elapsed;
          if (tmp <= 1) {
            _this2.particles.spawn(w.x, w.y);
            var addhole = _this2.holes.getFirstExists(false);
            addhole.reset(w.x, w.y);
            addhole.lifespan = 1000;

            _this2.game.physics.arcade.overlap(w, _this2.enemies, function (shot, enemy) {
              var explosionAnimation = _this2.explosions.getFirstExists(false);
              explosionAnimation.reset(shot.x, shot.y);
              explosionAnimation.play('explode', 30, false, true);

              setTimeout(function () {
                return enemy.html.click();
              }, _this2.clickdelay);
            });
          }
        }
...
/* 337 */
/*!******************************************!*\
  !*** ./src/sprites/particles-emitter.js ***!
  \******************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _class = function (_Phaser$Particles$Arc) {
  _inherits(_class, _Phaser$Particles$Arc);

  function _class(_ref) {
    var game = _ref.game,
        asset = _ref.asset,
        _ref$max = _ref.max,
        max = _ref$max === undefined ? 800 : _ref$max;

    _classCallCheck(this, _class);

    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, 0, 0, max));

    _this.makeParticles(asset);
    _this.blendMode = 1;
    return _this;
  }
  ...
  _createClass(_class, [{
    ...
    value: function spawn(x, y) {
      var particlesPerBurt = 5;
      var particleLifeSpan = 200;
  ...
  return _class;
}(_phaser2.default.Particles.Arcade.Emitter);
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    var game = _ref.game,
        ...
        y = _ref.y,
        asset = _ref.asset,
        _ref$initialVelocity = _ref.initialVelocity,
        initialVelocity = _ref$initialVelocity === undefined ? 0 : _ref$initialVelocity;
    ...
    _this.body.bounce.set(0.5);
    _this.angle = -90;
    _this.body.velocity.y = initialVelocity;

    _this.body.drag.set(40);
...
var _class = function (_Phaser$Group) {
  ...
  function _class(_ref) {
    ...
    for (var x = 0; x < instances; x++) {
      var newHole = _this.create(0, 0, asset, [0], false);
...
var _class = function (_Phaser$Weapon) {
  _inherits(_class, _Phaser$Weapon);
  ...
  function _class(_ref) {
    ...
    _this.createBullets(amount, asset);
    _this.bulletKillType = _phaser2.default.Weapon.KILL_LIFESPAN;
    _this.bulletLifespan = distance;
    _this.bulletSpeed = 800;
    _this.fireRate = 100;
    _this.bulletAngleVariance = 2;
    _this.bulletCollideWorldBounds = true;

    _this.trackSprite(ship, 0, 0, true);
    return _this;
  }

  return _class;
}(_phaser2.default.Weapon);
...
/* 342 */
/*!****************************************!*\
  !*** ./src/sprites/explose-emitter.js ***!
  \****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _class = function (_Phaser$Group) {
  ...
  function _class(_ref) {
    ...
    for (var x = 0; x < instances; x++) {
      var explosion = _this.create(0, 0, asset, [0], false);
...
var _class = function (_Phaser$Group) {
  ...
  function _class(_ref) {
    ...
    tags.forEach(function (t) {
      var tag = Array.from(document.querySelectorAll(t));
      tag.forEach(function (elem) {
        var coords = elem.getBoundingClientRect();
        var elw = elem.offsetWidth;
        var elh = elem.offsetHeight;

        var rect = game.add.sprite(coords.left, coords.top, null);
...
//# sourceMappingURL=arcade-navigation.js.map